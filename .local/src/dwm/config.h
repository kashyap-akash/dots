...
static const char *fonts[]          = { "JetBrainsMonoNerdFont:style=bold:pixelsize=14"};
static const char dmenufont[]       = {"JetBrainsMonoNerdFont:style=bold:pixelsize=14"};
...
static const Rule rules[] = {
	...
	//{ "obs",               NULL,     NULL,      1 << 4,         1,          0,           0,        -1 },
	//{ "Lutris",            NULL,     NULL,           0,         1,          0,           0,        -1 },
    //{ "Brave",             NULL,     NULL,          1 << 1,        0,         0,          0,        -1 },
    //{ "spotify-launcher",  NULL,     NULL,      1 << 2,        0,          0,           0,        -1 },
